...
<AccordionGroup>
  <Accordion icon="rocket" title="Get stores by brand (GET)">
  ...
  <Accordion icon="rocket" title="Create Stores and Sales Channels (POST)">
    ...
    <Accordion icon="rocket" title="Get store by ID (GET)">
  ...
  <Accordion icon="rocket" title="Change store status (PUT)">
...
### Lists
<AccordionGroup>
  <Accordion icon="rocket" title="Get Synchronization Report (GET)">
  ...
  <Accordion icon="rocket" title="Register or Edit a List (PUT)">
    This endpoint is used to add new stores and sales channels to the system. It facilitates the efficient expansion and updating of the store network.
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  <Accordion icon="rocket" title="Get Token">
  ...
  <Accordion icon="rocket" title="New Order Webhook">
  ...
  <Accordion icon="rocket" title="Order Retrieval">
...
<AccordionGroup>
  <Accordion icon="rocket" title="POST: Obtain OAuth token with a registered client">
  ...
  <Accordion icon="rocket" title="POST: Allows redeeming a local coupon using a UID and promotion code">
  ...
  <Accordion icon="rocket" title="POST: Registers tracking information for a specific order Allows registering tracking information for a specific order">
    This endpoint is crucial for keeping customers informed about the status and location of their orders in real-time.
  </Accordion>
  
  <Accordion icon="rocket" title="POST: Orders - Status Change This endpoint allows making changes to the order status">
    It is vital for managing and updating the status of orders as they progress through the fulfillment process.
  </Accordion>
  <Accordion icon="rocket" title="PUT: Orders - Transfer Enables the transfer of orders between different entities or warehouses">
    This endpoint is essential for managing logistics and ensuring that orders are delivered efficiently.
  </Accordion>
  <Accordion icon="rocket" title="POST: Pickup Orders - Dispatched This endpoint is used to mark pickup orders as dispatched">
    It helps coordinate the collection of orders by customers and ensures the pickup process runs smoothly.
  </Accordion>
    <Accordion icon="rocket" title="GET: Orders - Payment Information Allows retrieving payment information for orders">
