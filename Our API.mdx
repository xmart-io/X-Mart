...
<AccordionGroup>
  <Accordion icon="github" title="Get stores by brand (GET)">
  ...
  <Accordion icon="rectangle-terminal" title="Create Stores and Sales Channels (POST)">
    ...
    <Accordion icon="rectangle-terminal" title="Get store by ID (GET)">
  ...
  <Accordion icon="rectangle-terminal" title="Change store status (PUT)">
...
### Lists
<AccordionGroup>
  <Accordion icon="github" title="Get Synchronization Report (GET)">
  ...
  <Accordion icon="rectangle-terminal" title="Register or Edit a List (PUT)">
    This endpoint is used to add new stores and sales channels to the system. It facilitates the efficient expansion and updating of the store network.
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  <Accordion icon="github" title="Get Token">
  ...
  <Accordion icon="rectangle-terminal" title="New Order Webhook">
  ...
  <Accordion icon="rectangle-terminal" title="Order Retrieval">
...
<AccordionGroup>
  <Accordion icon="github" title="POST: Obtain OAuth token with a registered client">
  ...
  <Accordion icon="rectangle-terminal" title="POST: Allows redeeming a local coupon using a UID and promotion code">
  ...
  <Accordion icon="rectangle-terminal" title="POST: Registers tracking information for a specific order Allows registering tracking information for a specific order">
    This endpoint is crucial for keeping customers informed about the status and location of their orders in real-time.
  </Accordion>
  
  <Accordion icon="github" title="POST: Orders - Status Change This endpoint allows making changes to the order status">
    It is vital for managing and updating the status of orders as they progress through the fulfillment process.
  </Accordion>
  <Accordion icon="rectangle-terminal" title="PUT: Orders - Transfer Enables the transfer of orders between different entities or warehouses">
    This endpoint is essential for managing logistics and ensuring that orders are delivered efficiently.
  </Accordion>
  <Accordion icon="rectangle-terminal" title="POST: Pickup Orders - Dispatched This endpoint is used to mark pickup orders as dispatched">
    It helps coordinate the collection of orders by customers and ensures the pickup process runs smoothly.
  </Accordion>
    <Accordion icon="rectangle-terminal" title="GET: Orders - Payment Information Allows retrieving payment information for orders">
