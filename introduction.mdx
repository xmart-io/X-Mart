---
title: Introduction
description: 'Welcome to the X-Mart API Documentation!'
---
...
Below is an overview of the integration process, illustrating how X-Mart interacts with your ERP or POS system to manage stores, lists, and orders.

<img
  className="block dark:hidden"
  src="https://s3.us-east-1.amazonaws.com/admin.kfc.production/fondoclaroful.png"
  alt="Hero Light"
/>
<img
  className="hidden dark:block"
  src="https://s3.us-east-1.amazonaws.com/admin.kfc.production/fondoclaroosc.png"
  alt="Hero Dark"
/>
